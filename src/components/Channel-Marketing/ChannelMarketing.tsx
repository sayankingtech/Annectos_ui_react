...
const ChannelMarketing: React.FC = () => {
    ...
    return (
        <div className='w-[85%] mx-auto pt-5 mb-5'>
            <div className='grid md:grid-cols-3 mt-5 scroll-mt-[80px]' id='influence-eng'>
            ...
            <div className='grid md:grid-cols-3 mt-5 scroll-mt-[80px]' id='dormant-partner'>
            ...
            <div className='grid md:grid-cols-3 mt-5 scroll-mt-[80px]' id='channel-fit'>
                <div className='md:col-span-1' data-aos="fade-right">
            ...
            <div className='grid md:grid-cols-3 mt-5 scroll-mt-[80px]' id='sales-visib'>
                <div className='md:col-span-1 order-1 md:order-2' data-aos="fade-left">
            ...
            <div className='grid md:grid-cols-3 scroll-mt-[80px]' id='retail-active'>
                <div className='md:col-span-1' data-aos="fade-right">
                    <img src={image3} alt="" className='lg:h-[330px]' />
                </div>
