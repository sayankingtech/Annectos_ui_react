...
const EmployeeEngagement: React.FC = () => {
    ...
    return (
        <div className='w-[85%] mx-auto pt-5 mb-5'>
                ...
                <div className='grid md:grid-cols-3 overflow-x-hidden'>
                    ...
                    <div className='md:col-span-2 p-8 emplyo_eng' data-aos="fade-left">
                        ...
                        <p className='mt-5 text-justify'>
                            A chain is as strong as its weakest link. Similarly, your business is only as good as a single demotivated employee. Add to that the rising attrition rates. Work from home and hybrid models have rendered employee engagement more complex. The cry out there across enterprises is for truly motivating and effective employee engagement solutions that make work joyful. Morale across industries is at an all-time low thanks to the pandemic, and pathbreaking employee engagement is needed. A shift in employee goals from ‘survival’ to ‘fulfilment’ is evident. Organisations need to respond to this changing mindset by overhauling their rewards & recognition initiatives. Trouble caused by a single discontented employee might cascade to others quickly if not stemmed at source. Get in touch with us for innovative employee engagement programs.
                        </p>
                    </div>
                </div>
            </div>
            ...
            {/* Employee Rewards */}
            <div className='mt-5 scroll-mt-[80px]' id='emplyo-rwd'>
                <div className='grid md:grid-cols-3 overflow-x-hidden'>
                    <div className='md:col-span-1 order-1 md:order-2' data-aos="fade-left">
                        <img src={image2} alt="Employee Rewards" className='lg:h-[330px]' />
                    </div>
