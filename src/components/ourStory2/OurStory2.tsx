            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 w-[85%] mx-auto gap-6 mt-10 mb-10' data-aos="fade-up">
                <div className=' p-6 shadow-[0_1px_20px_rgba(0,0,0,0.25)]'>
                    <div className='flex items-center'>
                        ...
                        <h3 className='text-3xl md:text-4xl ps-4 font-bold'>5,40,000+</h3>
                    </div>
                ...
                <div className='p-6 shadow-[0_1px_20px_rgba(0,0,0,0.25)]'>
                    <div className='flex items-center'>
                        ...
                        <h3 className='text-3xl md:text-4xl ps-4 font-bold'>3,00,000+</h3>
                    </div>
                ...
                <div className='p-6 shadow-[0_1px_20px_rgba(0,0,0,0.25)]'>
                    <div className='flex items-center'>
                        ...
                        <h3 className='text-3xl md:text-4xl ps-4 font-bold'>20%</h3>
                    </div>
                ...
                <div className='p-6 shadow-[0_1px_20px_rgba(0,0,0,0.25)]'>
                    <div className='flex items-center'>
                        ...
                        <h3 className='text-3xl md:text-4xl ps-4 font-bold'>100,000+</h3>
                    </div>
